package com.mucanze.algamoney.api.repository.lancamento;
...
import com.mucanze.algamoney.api.model.Categoria_;
import com.mucanze.algamoney.api.model.Lancamento;
import com.mucanze.algamoney.api.model.Lancamento_;
import com.mucanze.algamoney.api.model.Pessoa_;
...
public class LancamentoRepositoryImpl implements LancamentoRepositoryQuery{
	...
	private void adicionaRestricoesDePaginacao(TypedQuery<?> query, Pageable pageable) {
		...
		int primeiroRegistroDaPagina = paginaActual * totalDeRegistroPorPagina;

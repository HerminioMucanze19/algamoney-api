...
public class LancamentoResource {
	...
	public ResponseEntity<Lancamento> updateLancamento(@PathVariable Long id, @Valid @RequestBody Lancamento lancamento){
		try{
			Lancamento lancamentoRetornado = lancamentoService.actualizar(id, lancamento);
